...
# ---------------- CONFIG ----------------
OUTPUT_ROOT = Path("/home/kshaltiel/code/CSE-495-Code/output/PROMPT_EXPERIMENTS/natural_setting")
DATASET_ROOT = Path("/home/kshaltiel/code/CSE-495-Code/COCO_IMAGES")
PER_IMAGE_JSON_ROOT = Path("/home/kshaltiel/code/CSE-495-Code/output/PROMPT_EXPERIMENTS_PER_IMAGE_METRICS/natural_setting") #full pipeline uses this, but we don't need to run this if we are just finding corrs
