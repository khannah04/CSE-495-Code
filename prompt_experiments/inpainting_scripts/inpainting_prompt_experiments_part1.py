...
# --- Define prompt strategies to experiment with (PART 1: First 3) ---
PROMPT_STRATEGIES = {
...
print(f"\n{'='*60}")
print("PART 1 PROMPT EXPERIMENTS COMPLETE!")
print(f"{'='*60}")
...
import subprocess
metrics_script = Path(__file__).parent / "calculate_metrics_prompt_experiments.py"
subprocess.run(["/home/kshaltiel/inpaint_env/bin/python", str(metrics_script)], check=True)

print(f"\n{'='*60}")
print("PART 1 PIPELINE COMPLETE! Generations and metrics ready.")
print(f"{'='*60}")
