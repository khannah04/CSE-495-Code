...
# --- Define prompt strategies to experiment with (PART 2: Last 3) ---
PROMPT_STRATEGIES = {
...
print(f"\n{'='*60}")
print("PART 2 PROMPT EXPERIMENTS COMPLETE!")
print(f"{'='*60}")
...
print(f"\n{'='*60}")
print("PART 2 PIPELINE COMPLETE! Generations and metrics ready.")
print(f"{'='*60}")
