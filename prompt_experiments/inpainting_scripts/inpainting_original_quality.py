...
# --- Define prompt strategy: original_quality ---
PROMPT_STRATEGIES = {
...
print(f"\n{'='*60}")
print("ORIGINAL_QUALITY PROMPT COMPLETE!")
print(f"{'='*60}")
...
subprocess.run([sys.executable, str(metrics_script)], check=True)

print(f"\n{'='*60}")
print("ORIGINAL_QUALITY PIPELINE COMPLETE! Generations and metrics ready.")
print(f"{'='*60}")
